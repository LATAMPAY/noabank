...
export const metadata = {
  title: "Productos | NOA BANK",
  description: "Descubrí nuestra amplia gama de productos diseñados para satisfacer todas tus necesidades.",
}
  ...
  return (
    <>
      <PageHeader
        ...
        description="Descubrí nuestra amplia gama de productos diseñados para satisfacer todas tus necesidades financieras."
        breadcrumbs={[{ label: "Productos", href: "/productos" }]}
      />
