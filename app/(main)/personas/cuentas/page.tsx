...
export const metadata = {
  title: "Cuentas Personales | NOA BANK",
  description:
    "Descubrí nuestras opciones de cuentas personales diseñadas para satisfacer tus necesidades financieras.",
}

export default function CuentasPersonalesPage() {
  const products = [
    {
      title: "Cuenta Única",
  ...
  return (
    <ProductCategoryLayout
      ...
      description="Descubrí nuestras opciones de cuentas personales diseñadas para satisfacer tus necesidades financieras."
      products={products}
      categoryPath="/personas/cuentas"
    />
  )
}
