...
export const metadata = {
  title: "Segmentos | NOA BANK",
  description: "Soluciones específicas para cada perfil de cliente en NOA BANK.",
}
...
export default function SegmentosPage() {
  return (
    <>
      <PageHeader
        title="Segmentos"
        description="En NOA BANK entendemos las necesidades únicas de cada sector y ofrecemos productos financieros especializados."
        breadcrumbs={[{ label: "Segmentos", href: "/segmentos" }]}
      />
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <Button asChild className={`bg-gradient-to-r ${segment.color} hover:opacity-90 transition-opacity`}>
                    <Link href={segment.link} className="flex items-center gap-2">
                      Conocer más
